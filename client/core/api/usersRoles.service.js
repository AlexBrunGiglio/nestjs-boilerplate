...
let UsersRolesService = class UsersRolesService {
    ...
    usersRolesControllerCreateOrUpdateRole(requestParameters, observe = 'body', reportProgress = false, options) {
    ...
    usersRolesControllerDeleteRoles(requestParameters, observe = 'body', reportProgress = false, options) {
        ...
        if (ids !== undefined && ids !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, ids, 'ids');
        }
        let localVarHeaders = this.defaultHeaders;
        let localVarCredential;
        // authentication (bearer) required
    ...
    usersRolesControllerGetUserRole(requestParameters, observe = 'body', reportProgress = false, options) {
    ...
    usersRolesControllerGetUserRoles(requestParameters, observe = 'body', reportProgress = false, options) {
        ...
        if (includeDisabled !== undefined && includeDisabled !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, includeDisabled, 'includeDisabled');
        }
        let localVarHeaders = this.defaultHeaders;
        let localVarCredential;
        // authentication (bearer) required
